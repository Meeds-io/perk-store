...
public class ProductOrderDAOTest extends BasePerkStoreTest {
  ...
  public void testGetOrders() {
    ...
    List<ProductOrderEntity> orders = orderDAO.getOrders(null, filter,false);
    assertNotNull(orders);
    assertEquals(0, orders.size(), 0);

    ProductEntity productEntity = newProduct();

    orders = orderDAO.getOrders(null, filter,false);
    assertNotNull(orders);
    assertEquals(0, orders.size(), 0);
    ...
    orders = orderDAO.getOrders("test", filter,false);
    assertNotNull(orders);
    assertEquals(1, orders.size(), 0);
    ...
    orders = orderDAO.getOrders(null, filterTmp, false);
    assertNotNull(orders);
