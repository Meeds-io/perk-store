...
import static org.exoplatform.addon.perkstore.statistic.StatisticUtils.*;
...
public class ExoPerkStoreStatisticAspect {
   ...
   */
  @Around("execution(* *(..)) && @annotation(org.exoplatform.addon.perkstore.statistic.ExoPerkStoreStatistic)")
